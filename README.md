...
## Setup
1. **Install Reflex** in your project.
2. **Add the package** from [Git](https://github.com/Urkidi/ExtensionsForReflexDI.git?path=/Assets/ExtensionsForReflexDI/):

```https://github.com/Urkidi/ExtensionsForReflexDI.git?path=/Assets/ExtensionsForReflexDI/```
